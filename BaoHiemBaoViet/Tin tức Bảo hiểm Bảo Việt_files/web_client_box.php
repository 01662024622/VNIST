/* Last update: 28/03/2018 15:08:36 */(function() {
 /***
 * vnpJs - Core
 ***/
...
function vgchatClientAppendMsgToBoxchat(data){
 ...
 var guest_name = $vnpJs('#vgc_import_name').val() || '';
 ...
 */
 ...
 if($vnpJs('#panel_chat_vatgia').length && !vgc_check_mobile_viewport){
 $vnpJs("#panel_chat_vatgia").css({"transform":"scaleX(1) scaleY(1)", "position":"fixed", "bottom":"0px", "right":"0", "width":"100%", "max-width":"300px"});
 }
...
var _vcclient = {
 ...
 var msg = 'http://maps.google.com/maps?q='+ lat +',' + lon;
 $vnpJs('#vgc_message').val(msg);
...
vgq('init', '1');
vgq('track', "PageView");var url_server_vgchat_client = "//live.vnpgroup.net/js/";var vgc_js_permission = {customer_online:1,history_chat:1,history_search:1,message_offline:1,tags:1,label:1,office:1,permission:1,email_offline:1,report:1,report_office:1,app_desktop:1,app_mobile:1,tranfer:1,baned:1,show_boxchat:1,max_chat:0,answer_auto:1,payment:1,orther_setting:1,greet_setting:1,customer_send_location:1,customer_send_image:1,customer_poll:1,show_office:1,seting_target:1,};var web_vchat_id = 5054113;_vcclient_config = {themes: {box_color:'#0072BD',box_position:'right',template:1,link_like:'https://www.facebook.com/vchat.vn'},greeting: {invite_showbox : {vl:1,time:2,first_msg:'Mời bạn Chat hoặc gọi: 098.1234.433',name:'Bật boxchat kèm câu chat tự động chào khách hàng'},invite_times : {vl:1,time:10,first_msg:'Em có thể giúp gì cho a/c, hãy đặt câu hỏi đi ạ!',name:'Mời chat sau một khoảng thời gian nhất định'},return_visit : {vl:1,time:5,first_msg:'Xin chào anh/chị đã quay trở lại website, a/c có cần em giúp gì không?',name:'Mời chat đối với khách quay lại'},new_visit : {vl:1,time:5,first_msg:'Anh chị hãy đặt câu hỏi hoặc để lại số điện thoại em sẽ hỗ trợ ngay ạ?',name:'Mời chat đối với khách mới'},after3page : {vl:1,time:10,first_msg:'Chào anh/chị, a/c có cần em giúp gì không?',name:'Mời chat sau khi đã xem quá 03 trang'},onpage_special : {vl:0,time:10,first_msg:'Chào bạn bạn có cần tôi giúp gì không?',contain_text:'',name:'Mời chat trên đường dẫn chỉ định'}},eyechat: {icon_eye_chat:71,show_eye_chat:1,time_show_eye_chat:4,time_close_eye_chat:20},text: {title_online : {name:'Chat ngay hoặc gọi: 098.1234.433',holder:'Tiêu đề khi bạn Online',maxlen:50},company_name : {name:'Hotline tư vấn:',holder:'Tên hỗ trợ',maxlen:40},conpany_phone : {name:0981234433,holder:'Số điện thoại hỗ trợ',maxlen:40},company_address : {name:'Zalo, Viber: 098.1234.433',holder:'Địa chỉ công ty',maxlen:60},sugget_chat : {name:'Gõ vào đây và nhấn <enter> để chat',holder:'Hướng dẫn khách hàng nhập vào ô chat',maxlen:80},title_msg_offline : {name:'Vui lòng để lại lời nhắn',holder:'Tiêu đề gửi tin nhắn khi bạn Offline',maxlen:50},msg_default : {name:'Câu chào mặc định khi chat với khách',holder:'Câu chào mặc định khi chat với khách',maxlen:100},title_mobile_online : {name:'Chat',holder:'Tiêu đề khi bạn online trên bản mobile',maxlen:100},title_mobile_offline : {name:'Gửi tin nhắn',holder:'Tiêu đề khi bạn offline trên bản mobile',maxlen:100}},autoreply: {auto_reply:1,auto_reply_first:'Chào bạn! Tôi có thể giúp gì cho bạn?',auto_reply_second:'Bạn vui lòng chờ trong giây lát, hỗ trợ của chúng tôi sẽ giúp bạn ngay bây giờ'},payment: {logo : {img:'gqa1513592934.jpg',logo_link:'https://baohiembaoviet.com'},advertive : {title:'Tư vấn viên Nga My: 098.1234.433 - Zalo, Viber: 098.1234.433',link:'https://baohiembaoviet.com'}},orther: {from_info : {vl:1,name:'Nhập thông tin cá nhân trước khi chat',note:'Khi sử dụng tính năng này, khách hàng phải điền các thông tin cá nhân trước khi chat ( Họ tên, Email, Số điện thoại, Địa chỉ).',field:'Array',question:'Array'},show_office : {vl:0,name:'Chọn bộ phận hỗ trợ trước khi chat',note:'Khi sử dụng tính năng này, khách hàng phải lựa chọn Bộ phận hỗ trợ phù hợp trước khi chat.  Để tính năng này hoạt động, bạn cần tạo trước ít nhất 2 bộ phận trong mục Bộ phận hỗ trợ.'},send_file : {vl:1,name:'Cho phép khách hàng gửi ảnh và file khi chat',note:'Khi sử dụng tính năng này, khách hàng của bạn có thể gửi ảnh và file qua cửa chat khi chat. Các định dạng file được vChat.vn hỗ trợ bao gồm: .jpg,.jpeg,.gif,.png,.doc,.docx,.xls,.xlsx,.pdf,.txt'},poll : {vl:0,name:'Yêu cầu đánh giá sau chat',note:'Khi sử dụng tính năng này, khách hàng của bạn có thể đánh giá chất lượng cuộc chat ngay khi kết thúc chat.'},require_chat : {vl:1,time:30,name:'Cho phép khách hàng yêu cầu chat khi chờ quá lâu',note:'Với chức năng này, khi khách hàng không được hỗ trợ viên trả lời lại sau một khoảng thời gian cài đặt nhất định, họ sẽ nhận được một nút bấm Yêu cầu chat để thông báo cho hỗ trợ viên.',text:'Chào bạn! Hiện tại tôi đang cần được hỗ trợ'},auto_rep_buzy : {vl:1,time:60,name:'Tự động trả lời khách hàng khi khách đợi quá lâu',note:'Với chức năng này, khi hách hàng không được hỗ trợ viên trả lời sau một khoảng thời gian cài đặt nhất định, hệ thống tự động trả lời khách hàng với cú pháp kèm theo.',text:'Chào bạn! Hiện tại tôi đang không có ở đây hoặc tôi đang rất bận, bạn vui lòng gọi vào số Hotline để được tư vấn trực tiếp. Cảm ơn bạn'},rep_when_cancel : {vl:1,name:'Trả lời lại khách khi bạn click vào nút Cancel khi khách yêu cầu trả lời',note:'Với chức năng này, hệ thống sẽ tự động trả lời khách hàng khi hỗ trợ viên nhấn vào nút Cancel khi khách hàng gửi Yêu cầu chat.',text:'Chào bạn! Hiện tại tôi đang không có ở đây hoặc tôi đang rất bận, bạn vui lòng gọi vào số Hotline để được tư vấn trực tiếp. Cảm ơn bạn'}},size: {w:300,h:400},chs_lang_id: {lang:'vi'},text_en: {title_online : {name:'Chat with us!',holder:'Chat with us!',maxlen:50},company_name : {name:'Support',holder:'Company name',maxlen:40},conpany_phone : {name:'',holder:'company phone',maxlen:40},company_address : {name:'',holder:'Company address',maxlen:60},sugget_chat : {name:'Type your message here',holder:'Type your message here',maxlen:80},title_msg_offline : {name:'Send us a message!',holder:'Title when you are offline.',maxlen:50},msg_default : {name:'',holder:'Câu chào mặc định khi chat với khách',maxlen:100},title_mobile_online : {name:'Chat',holder:'Title online on Mobile',maxlen:100},title_mobile_offline : {name:'Send message',holder:'Title offline on Mobile',maxlen:100}}};setTimeout("call_start_function_client()", 1000);var vc_lang = {"change_avatar":"Thay \u1ea3nh \u0111\u1ea1i di\u1ec7n","title_show":"Tr\u1ea1ng th\u00e1i","title_online":"Ti\u00eau \u0111\u1ec1 khi b\u1ea1n online","title_msg_offline":"Vui l\u00f2ng \u0111\u1ec3 l\u1ea1i l\u1eddi nh\u1eafn","company_name":"T\u00ean h\u1ed7 tr\u1ee3","conpany_phone":"S\u1ed1 \u0111i\u1ec7n tho\u1ea1i h\u1ed7 tr\u1ee3","company_address":"\u0110\u1ecba ch\u1ec9 c\u00f4ng ty","sugget_chat":"H\u01b0\u1edbng d\u1eabn kh\u00e1ch h\u00e0ng g\u1eedi tin nh\u1eafn","msg_default":"C\u00e2u ch\u00e0o m\u1eb7c \u0111\u1ecbnh khi chat v\u1edbi kh\u00e1ch","setting":"C\u00e0i \u0111\u1eb7t","info_title":"Ch\u1ecdn b\u1ed9 ph\u1eadn online \u0111\u1ec3 c\u00f3 th\u1ec3 h\u1ed7 tr\u1ee3 b\u1ea1n","choose_office":"Ch\u1ecdn b\u1ed9 ph\u1eadn","s_name":"H\u1ecd t\u00ean","s_email":"Email","s_phone":"S\u1ed1 \u0111i\u1ec7n tho\u1ea1i","s_address":"\u0110\u1ecba ch\u1ec9","info_loginwith":"\u0110\u0103ng nh\u1eadp v\u1edbi","btn_savechat":"L\u01b0u & B\u1eaft \u0111\u1ea7u chat","btn_ignore":"B\u1ecf qua","poll_title":"B\u1ea1n c\u00f3 mu\u1ed1n k\u1ebft th\u00fac cu\u1ed9c tr\u00f2 chuy\u00ean n\u00e0y kh\u00f4ng?","poll_btn_yes":"\u0110\u00e1nh gi\u00e1","poll_btn_exit":"Tho\u00e1t","offline_title_phone":"\u0110T","offline_name":"T\u00ean c\u1ee7a b\u1ea1n","offline_email":"Email","offline_phone":"S\u1ed1 \u0111i\u1ec7n tho\u1ea1i","offline_mes":"Tin nh\u1eafn (kh\u00f4ng qu\u00e1 255 k\u00fd t\u1ef1)","offline_title_mobile":"G\u1eedi tin","offline_btn":"G\u1eedi tin nh\u1eafn","btn_save":"L\u01b0u c\u00e0i \u0111\u1eb7t","language":"Ng\u00f4n ng\u1eef","mini_box":"Thu nh\u1ecf khung chat","exit_chat":"D\u1eebng chat","send_location":"G\u1eedi v\u1ecb tr\u00ed c\u1ee7a b\u1ea1n cho ch\u1ee7 web","send_photo":"G\u1eedi \u1ea3nh minh h\u1ecda cho ch\u1ee7 web","error_office":"B\u1ea1n ch\u01b0a ch\u1ecdn b\u1ed9 ph\u1eadn h\u1ed7 tr\u1ee3","error_name":"B\u1ea1n ch\u01b0a nh\u1eadp t\u00ean","error_email":"B\u1ea1n ch\u01b0a nh\u1eadp email","error_phone":"B\u1ea1n ch\u01b0a nh\u1eadp s\u1ed1 \u0111i\u1ec7n tho\u1ea1i","error_mes":"B\u1ea1n ch\u01b0a nh\u1eadp n\u1ed9i dung tin nh\u1eafn","error_address":"B\u1ea1n ch\u01b0a nh\u1eadp \u0111\u1ecba ch\u1ec9","greeting_close":"T\u1eaft m\u1eddi chat","greeting_send":"G\u1eedi tin nh\u1eafn","greeting_holder":"Nh\u1eadp n\u1ed9i dung v\u00e0 nh\u1ea5n <Enter>","require_chat":"B\u1ea1n \u0111\u1ee3i \u0111\u00e3 kh\u00e1 l\u00e2u, b\u1ea1n c\u00f3 mu\u1ed1n y\u00eau c\u1ea7u tr\u1ea3 l\u1eddi?","require_send":"Y\u00eau c\u1ea7u h\u1ed7 tr\u1ee3 ngay","require_ignore":"B\u1ecf qua","send_offline":"C\u1ea3m \u01a1n b\u1ea1n \u0111\u00e3 g\u1eedi tin nh\u1eafn cho ch\u00fang t\u00f4i. Ch\u00fang t\u00f4i s\u1ebd li\u00ean h\u1ec7 v\u1edbi b\u1ea1n trong th\u1eddi gian s\u1edbm nh\u1ea5t.","send_offline_over":"Xin l\u1ed7i v\u1ec1 s\u1ef1 b\u1ea5t ti\u1ec7n n\u00e0y! B\u1ea1n ch\u1ec9 \u0111\u01b0\u1ee3c g\u1eedi tin nh\u1eafn \u0111\u1ebfn cho kh\u00e1ch h\u00e0ng 03 l\u1ea7n trong ng\u00e0y.","offline_text":"Th\u00f4ng tin khi b\u1ea1n offline","offline_note":"V\u00ed d\u1ee5 c\u1ee7a t\u00f4i"};var vgc_webowner_status = 0;var vgc_cuid = 1042652725;var vgc_client_box_data = "send_id=1042652725&to_id=5054113&hash=b19b840d71ba551c43b05029e4d1e990&nocache=0";
