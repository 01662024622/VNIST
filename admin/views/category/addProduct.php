    ...
    <div class="panel-body">
		<form action="?mod=categories&act=storeProduct" method="POST" role="form" style="margin-top: 80px;">
			...
			<div class="form-group">
				...
				<input name="category_id" type="text" value="<?= $category_id ?>" readonly class="form-control" placeholder="Input field">
			</div>
